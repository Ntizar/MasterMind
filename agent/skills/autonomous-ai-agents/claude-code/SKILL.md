...
- **[Gentleman-Programming/...](https://github.com/Gentleman-Programming)** — CLI en Go que convierte un agente en un entorno de ingeniería configurado (rules, checklists, tareas); útil para dar a Claude/OpenCode un entorno de trabajo listo con reglas y tareas.
