...
- **[VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md)** — 73 DESIGN.md de webs top como seed de token-spec y patrones de design system verificables; una colección de referencias reales para inspirar el token-spec de un proyecto.
