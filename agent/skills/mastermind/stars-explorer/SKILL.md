...
- **Auditoría quantstats-pro completada (2026-09-04):** de la lista pendiente (gtfs-tidy, gtfs2shp, colmap-view, quantstats-pro), queda auditado y reescrito quantstats-pro → v2.0.0. Siguen pendientes de auditoría v1: gtfs-tidy, gtfs2shp, colmap-view.
