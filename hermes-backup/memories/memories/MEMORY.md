...
§
[santander-ai-lab] 11 repos SantanderAI en stars. Top 3 útiles: gen-fraud-graph (132⭐, grafos sintéticos), linear-adapter-trainer (15⭐, fine-tune embeddings), auto-bayesian (24⭐, redes Bayesianas).
§
...
§
[proyecto-gbfsspain] Repo Ntizar/GBFSSpain (privado). Visor de 68 sistemas GBFS de bicicletas en España (58 ciudades, 9 plataformas). 38 sistemas v3.0. Catálogo en data/systems.json. Estilo GTFSSpain pero con JSON en vez de CSV. URLs: github.com/Ntizar/GBFSSpain