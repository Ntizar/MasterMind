...
- Cuando se necesita auditoría estática del código fuente → usar `web-audit` en su lugar
- Cuando se necesita analizar headers de seguridad, SSL o rendimiento sin interacción → usar `web-audit`
- Cuando la aplicación no es web (CLI, backend API sin interfaz) → usar `systematic-debugging` o testing directo
