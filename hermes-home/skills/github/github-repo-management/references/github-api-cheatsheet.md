...
| Action | Method | Endpoint |
|--------|--------|----------|
| Get Pages info | GET | `/repos/{owner}/{repo}/pages` |
| Enable Pages | POST | `/repos/{owner}/{repo}/pages` |
| Update Pages config | PUT | `/repos/{owner}/{repo}/pages` |
| Delete Pages site | DELETE | `/repos/{owner}/{repo}/pages` |
| List builds | GET | `/repos/{owner}/{repo}/pages/builds` |
| Latest build | GET | `/repos/{owner}/{repo}/pages/builds/latest` |
| Cancel build | POST | `/repos/{owner}/{repo}/pages/builds/latest/cancel` |

**Pitfall:** `GET /pages` returns `{"status": "building"}` while the site is being rebuilt after a push. Poll until `"built"` before verifying the live URL.
