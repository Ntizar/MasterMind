...
- **Corporate / consulting (fondo blanco):** Ver `references/consulting-corporate-style.md` — McKinsey/BCG style, tablas limpias, KPI tiles, sin glass/mesh/orbs. Para presentaciones de caso de negocio, propuestas, roadmaps. **NO usar Aurora** para este estilo.