...
- **238 SKILL.md** en `repo/` (copia antigua con histórico)
...
- **Repo repo/**: 238 SKILL.md (histórico, se mantiene como backup antiguo)
...
- Copia `agent/skills/` → `/root/workspace/Mastermind/skills/`
- Commit + push automático si hay cambios

## Archivos modificados
- `/root/workspace/Mastermind/skills/` — Limpieza completa
- `scripts/sync-skills-to-mastermind.sh` — Script de sync
...
find agent/skills -name "SKILL.md" | wc -l  # 188
find /root/workspace/Mastermind/skills -name "SKILL.md" | wc -l  # 188

# Verificar igualdad
diff <(cd agent/skills && find . -name "SKILL.md" | sort) \
