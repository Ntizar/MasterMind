...
- Quieres escribir letras originales o adaptar/parodiar una canción existente
- Necesitas crear prompts detallados para Suno AI (estilo, estructura, metatags)
- Buscas mejorar la métrica, rima y prosodia de tus letras
- Quieres generar voces AI realistas con control fonético preciso

## Cuándo NO usar

- Necesitas producción musical completa (mezcla, master, instrumentación) → usa `comfyui` con modelos de audio o Suno directamente
- Quieres componer partituras o notación musical profesional → usa MuseScore o Sibelius
- El objetivo es generar música sin texto/letra → usa `heartmula` o `comfyui`
...
VOCAL: [Whispered] [Spoken Word] [Belted] [Falsetto] [Powerful] [Soulful] [Raspy] [Breathy] [Smooth] [Gritty] [Staccato] [Legato] [Vibrato] [Melismatic] [Harmonies] [Choir] [Harmonized Chorus]
...
Put tags in BOTH style field AND lyrics for reinforcement. Keep to 5-8 tags per section max. Don't contradict yourself.
...
- **Phonetic respelling:** "Nous" → "Noose", "through" → "thru". Proper nouns are highest failure rate — test early. Hyphenate: "Re-search", "bio-engineering"
- **Delivery control:** ALL CAPS = louder. Vowel extension: "lo-o-o-ove" = sustained. Ellipses: "I... need... you" = dramatic pauses. Hyphenated: "ne-e-ed" = emotional stretch
- **Always:** Spell out numbers ("24/7" → "twenty four seven"). Space acronyms ("AI" → "A I"). Test proper nouns in a 30-second clip first. Pronunciation is baked in — fix in lyrics BEFORE generating.
...
- Keeping some original lines in a parody adds recognizability and emotional weight
- The bridge is where you can transform imagery while keeping emotional function
- Monosyllabic word swaps in hooks are the cleanest way to maintain rhythm while changing meaning
- A strong vocal persona description makes a bigger difference than any single metatag
- If a line breaks meter but hits harder, keep it. The feeling is what matters.
